...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04C36770;
	constexpr int32 AppendString      = 0x01152760;
	constexpr int32 GNames            = 0x04BFA2C0;
	constexpr int32 GWorld            = 0x04D7AD78;
	constexpr int32 ProcessEvent      = 0x0136ED10;
