...
struct BP_Note_C_OnActorUsed final
{
public:
...
DUMPER7_ASSERTS_BP_Note_C_OnActorUsed;

// Function BP_Note.BP_Note_C.ExecuteUbergraph_BP_Note
// 0x00F8 (0x00F8 - 0x0000)
struct BP_Note_C_ExecuteUbergraph_BP_Note final
{
public:
	...
	class ACharacter*                             K2Node_Event_Character;                            // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_GetCurrentCulture_ReturnValue;            // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          CallFunc_NotEqual_StrStr_ReturnValue;              // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsHeadMountedDisplayEnabled_ReturnValue;  // 0x0059(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_5A[0x6];                                       // 0x005A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FS_Note                                CallFunc_GetDataTableRowFromName_OutRow;           // 0x0060(0x0018)(HasGetValueTypeHash)
	...
	struct FHE_Subtitle                           K2Node_MakeStruct_HE_Subtitle;                     // 0x0080(0x0050)(HasGetValueTypeHash)
	TArray<struct FHE_Subtitle>                   K2Node_MakeArray_Array;                            // 0x00D0(0x0010)(ReferenceParm)
	struct FHE_SubtitleSeq                        K2Node_MakeStruct_HE_SubtitleSeq;                  // 0x00E0(0x0018)(HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_Note_C_ExecuteUbergraph_BP_Note;
